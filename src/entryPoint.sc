...
theme: /
    state: Запуск
        ...
        if: $temp.appeal == "official"
            a: Добро пожаловать в rererre! Чтобы добавить новую, просто скажите "Запомни" и  нужный текст.
        elseif: $temp.appeal == "no_official"
            a: Добро пожаловать в rerer! Чтобы добавить новую, просто скажи "Запомни" и  нужный текст.
        else:
